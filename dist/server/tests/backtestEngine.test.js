...
const historicalDataService_1 = require("../services/backtest/historicalDataService");
describe('Backtest Engine', () => {
    beforeAll(() => {
        // Mock HistoricalDataService
        jest.spyOn(historicalDataService_1.HistoricalDataService, 'getHistoricalData').mockImplementation(async (symbol, interval, start, end) => {
    ...
    it('should correctly simulate a LONG WIN', async () => {
        ...
        const res = await backtestEngine_1.BacktestEngine.runBacktest(opp, 0, 0); // 0 fees/slippage
    ...
    it('should correctly handle EXPIRED', async () => {
        ...
        const res = await backtestEngine_1.BacktestEngine.runBacktest(opp, 0, 0);
