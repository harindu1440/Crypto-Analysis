...
describe('AdaptiveIntelligenceService', () => {
    ...
    test('returns COLD_START when no profile exists', () => {
        database_1.LocalDatabase.get.mockReturnValue({});
        const result = adaptiveIntelligenceService_1.AdaptiveIntelligenceService.calibrateSignal(mockSignal, mockQualityEval, {});
